...
public struct LoopSettings: Equatable {
    ...
    public var customLoopInterval: TimeInterval = LoopSettings.minimumCustomLoopInterval
    ...
    public init(
        ...
        customLoopInterval: TimeInterval = LoopSettings.minimumCustomLoopInterval,
